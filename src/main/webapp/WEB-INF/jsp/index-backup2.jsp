...
<script>
    ...
    function trainBox() {
        ...
        for (var i = 0; i < 20; i++) {
            var div = "<div style=\"width:340px; height: 200px;margin:5px;float:left;\" id=\"test\" class=\"test\">" +
                "<div style=\"width:340px;height:170px;\" class=\'optlq\' id=\"optlq"+i+"\"></div>" +
                  "<div id=\"test1\" class=\"test1\" style=\"width: 340px;height: 30px;\">" +
                    "<p class=\"text-info\" style=\"text-align: center;\">乌鲁木齐车队-乌1组-6-2</p>" +
                  "</div>" +
                "</div>"
